...
app.get('/', (req, res)=>{
    let url = 'https://api.themoviedb.org/3/movie/447365?api_key=da115a981452d1db6a9d288d0a166968';
    axios.get(url)
    .then(response => {
...
app.post('/search', (req, res) => {
    ...
    let movieUrl = `https://api.themoviedb.org/3/search/movie?query=${userMovieTitle}&api_key=da115a981452d1db6a9d288d0a166968`;
    let genresUrl = 'https://api.themoviedb.org/3/genre/movie/list?api_key=da115a981452d1db6a9d288d0a166968&language=en';
    ...
    .then(axios.spread((movie, genres) => {
        ...
        genresToDisplay = genresToDisplay.slice(0, -1) + '.';
...
app.post('/getmovie', (req, res) => {
	...
	const reqUrl = encodeURI(
		`http://www.omdbapi.com/?t=${movieToSearch}&apikey=e36a1096`
	);
	http.get(
		reqUrl,
		responseFromAPI => {
